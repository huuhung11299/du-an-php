...
?>
    ...
    <div class="catagory-featured-post bg-overlay clearfix" style="background-image: url(../view/website/img/bg-img/23.jpg)">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-9">
                    ...
                    <div class="post-content">
                        ...
                        <a href="#" class="post-title">Top 10 <br> ômmmmm</a>;
                        ...
                        <div class="intro-news-filter d-flex justify-content-between">
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <a class="nav-item nav-link active" id="nav1" data-toggle="tab" href="#nav-1" role="tab" aria-controls="nav-1" aria-selected="true">ommmm</a>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            ...
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/24.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/14.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/15.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/4.jpg" alt=""></a>
                                            </div>
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/5.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/25.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/26.jpg" alt=""></a>
                                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="single-blog-post style-2 mb-5">
                                            <!-- Blog Thumbnail -->
                                            <div class="blog-thumbnail">
                                                <a href="#"><img src="../view/website/img/bg-img/27.jpg" alt=""></a>
                                            </div>
                    ...
                    <div class="sidebar-area">
                        ...
                        <div class="single-widget-area news-widget mb-30">
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="../view/website/img/bg-img/16.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="../view/website/img/bg-img/17.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="../view/website/img/bg-img/18.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="../view/website/img/bg-img/19.jpg" alt=""></a>
                                </div>
                            ...
                            <div class="single-blog-post d-flex style-4 mb-30">
                                <!-- Blog Thumbnail -->
                                <div class="blog-thumbnail">
                                    <a href="#"><img src="../view/website/img/bg-img/20.jpg" alt=""></a>
                                </div>
    ...
    <div class="big-add-area">
        <div class="container-fluid">
            <a href="#"><img src="../view/website/img/bg-img/add4.png" alt=""></a>
        </div>
    </div>
    <!-- ##### Add Area End ##### -->
            ...
            <div class="row">
                <div class="col-12 col-md-8 col-lg-9">
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/28.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/29.jpg" alt=""></a>
                        </div>
                    ...
                    <div class="single-blog-post d-flex flex-wrap style-5 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/30.jpg" alt=""></a>
                        </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/11.jpg" alt=""></a>
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/12.jpg" alt=""></a>
                            <a href="#" class="video-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
                    ...
                    <div class="single-blog-post style-6 mb-30">
                        <!-- Blog Thumbnail -->
                        <div class="blog-thumbnail">
                            <a href="#"><img src="../view/website/img/bg-img/13.jpg" alt=""></a>
                            <a href="#" class="video-btn"><i class="fa fa-play" aria-hidden="true"></i></a>
                        </div>
