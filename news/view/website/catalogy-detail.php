...
<?php
    ...
    $cate = new news();
    $id = $_GET['idcate'];
        $tin =$cate->getCateById($id);
            extract($tin);
            $hinh = '../view/upload/'.$tin['hinhanh'];
            if(is_file($hinh)){
                $hinh=$hinh;
              }else{
                $hinh="no data";
...
?>
    ...
    <div class="post-details-title-area bg-overlay clearfix" style="background-image: url(<?php echo  $hinh?>)">
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12 col-lg-8">
                    ...
                    <div class="post-content">
                        ...
                        <p class="post-title"> <?php echo  $tin['tieude']?> </p>
                        <div class="d-flex align-items-center">
                      
                            <span class="post-date mr-30"><?php echo $tin['thoigian']?></span>
                            <span class="post-date"><?php echo $tin['tacgia']?></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="post-news-area section-padding-100-0 mb-70">
        <div class="container">
            <div class="row justify-content-center">
                ...
                <!-- Day la phan noi dung tin tuc -->
                    <div class="post-details-content mb-100">
                        <p><?php echo $tin['noidung']?></p>
                    </div>
                <!-- Het phan noi dung tin tuc -->
                            ...
                            <li class="single_comment_area">
                                ...
                                <div class="comment-content d-flex">
                                    ...
                                    <div class="comment-author">
                                        <img src="../view/website/img/bg-img/32.jpg" alt="author">
                                    </div>
                                    <!-- Comment Meta -->
                                ...
                                <ol class="children">
                                    <li class="single_comment_area">
                                        ...
                                        <div class="comment-content d-flex">
                                            <!-- Comment Author -->
                                            <div class="comment-author">
                                                <img src="../view/website/img/bg-img/33.jpg" alt="author">
                                            </div>
                                            <!-- Comment Meta -->
                                            <div class="comment-meta">
                                                <div class="d-flex">
