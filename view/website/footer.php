     ...
     <footer class="footer-area">
        ...
        <div class="footer-logo mb-100">
            <a href="index.html"><img src="../view/website/img/core-img/logo.png" alt=""></a>
        </div>
        <!-- Footer Content -->
        <div class="container">
            <div class="row">
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <!-- jQuery-2.2.4 js -->
    <script src="../view/website/js/jquery/jquery-2.2.4.min.js"></script>
    <!-- Popper js -->
    <script src="../view/website/js/bootstrap/popper.min.js"></script>
    <!-- Bootstrap js -->
    <script src="../view/website/js/bootstrap/bootstrap.min.js"></script>
    <!-- All Plugins js -->
    <script src="../view/website/js/plugins/plugins.js"></script>
    <!-- Active js -->
    <script src="../view/website/js/active.js"></script>
</body>
</html>